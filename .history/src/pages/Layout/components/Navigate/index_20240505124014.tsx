        ...
        <div className="container">
            ...
            <ul className="nav">
                {NAV_LIST.map((item, index) => {
                    return (
                        <li className={`nav-item ${params.get('keyword') === item.name ? 'nav-item-active' : (location.pathname === item.path && !params.get('keyword')) && 'nav-item-active'}`} key={index} onClick={() => { navigate(item.path) }}>

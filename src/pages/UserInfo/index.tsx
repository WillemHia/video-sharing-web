...
import Mark from "../Layout/components/Mark";
...
const Myself: FC = () => {
    ...
    return (
        <div className="container">
            {isMobile ?
                ...
                (<header className="header">
                    ...
                    <div className="header-options">
                        {/* <Button>关注</Button> */}
                        <Button style={{ backgroundColor: 'rgba(255,255,255,0.35)' }} onClick={() => setIsEdit(true)}>编辑信息</Button>
                    </div>
                </header>
                )}
            <div className="body">
            ...
            {isEdit &&
                <Mark onClose={() => setIsEdit(false)}>
                    <EditModal onClose={() => setIsEdit(false)}/>
                </Mark>
            }
        </div>
    );
